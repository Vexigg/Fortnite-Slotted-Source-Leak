...
namespace ImGui
{
    ...
    IMGUI_API bool          Renderingtab(const char* icon, bool selected);
...
//#endif
    ...
    IMGUI_API ImGuiKeyData* GetAsyncKeyState_SpoofedData(ImGuiKey key);
    IMGUI_API void          GetAsyncKeyState_SpoofedChordName(ImGuiModFlags mods, ImGuiKey key, char* out_buf, int out_buf_size);
    ...
    IMGUI_API ImVec2        GetAsyncKeyState_SpoofedVector2d(ImGuiKey key_left, ImGuiKey key_right, ImGuiKey key_up, ImGuiKey key_down);
